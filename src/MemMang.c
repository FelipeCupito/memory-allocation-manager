...
**   -> Se reducieron las llamas al sistema con la funcion MemManager() la cual simpre pide MIN_BYTES_REQUEST bytes que luego va administra.
**   -> Si el tamaño del bloque devuelto por findFreeBlock() supera en MAX_DIFF_SIZE al tamaño neceasrio entonces se divide el bolque en dos.
**   -> pasar int free a char free
**   -> mejora de diseño en la funciones de debugger
*/
#include "MemMang.h"
